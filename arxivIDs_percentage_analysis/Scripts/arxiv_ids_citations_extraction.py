    ...
    for filename in list_of_files:
        ...
        if contents.find(r"\bibitem") > -1:
            ...
            for i, bibitem in enumerate(list_of_bibitems):
                ...
                if flexible_arxiv_id and not strict_arxiv_id:
                    flexible_ids += 1
...
with open(
    "arxivIDs_percentage_analysis/arxiv_ids_by_years_all_hep-ex.json", "r"
) as datafile:
...
with open(
    "arxivIDs_percentage_analysis/arxiv_id_percentage_hep-ex.json", "w"
) as datafile:
